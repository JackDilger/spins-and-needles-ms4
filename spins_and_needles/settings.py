...
ALLOWED_HOSTS = ['spins-and-needles.herokuapp.com', 'localhost', '127.0.0.1']
...
MIDDLEWARE = [
    ...
    'spins_and_needles.middleware.SecurityHeadersMiddleware',  # Custom COOP + CSP headers
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'spins-and-needles'
